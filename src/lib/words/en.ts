export const ENGLISH_WORDS: string[] = [
  'AGENT', 'AIRPLANE', 'ALIEN', 'ALPS', 'AMAZON', 'AMBULANCE', 'AMERICA', 'ANGEL', 'ANTARCTICA', 'APPLE',
  'ARM', 'ATLANTIS', 'AUSTRALIA', 'AZTEC', 'BACK', 'BALL', 'BANANA', 'BANK', 'BAR', 'BARK',
  ...
  'CHOCOLATE', 'CHURCH', 'CIRCLE', 'CLIFF', 'CLOAK', 'CLOCK', 'CLOWN', 'CLUB', 'CLUE', 'COACH',
  'COAL', 'COLD', 'COMIC', 'COMPOUND', 'CONCERT', 'CONDUCTOR', 'CONTRACT', 'COOK', 'COPPER', 'COTTON',
  'COURT', 'COVER', 'CRANE', 'CRASH', 'CRICKET', 'CROOK', 'CROSS', 'CROWN', 'CYCLE', 'CZECH',
  ...
  'FENCE', 'FIELD', 'FIGHTER', 'FIGURE', 'FILE', 'FILM', 'FIRE', 'FISH', 'FLUTE', 'FLY',
  ...
  'KIWI', 'KNIFE', 'KNIGHT', 'LAB', 'LAP', 'LASER', 'LAWYER', 'LEAD', 'LEMON', 'LEPRECHAUN',
  'LIFE', 'LIGHT', 'LIMOUSINE', 'LINE', 'LINK', 'LION', 'LITTER', 'LOCH NESS', 'LOCK', 'LOG',
  'LONDON', 'LUCK', 'MAIL', 'MAMMOTH', 'MAN', 'MAPLE', 'MARCH', 'MASS', 'MATCH', 'MERCURY',
  'MEXICO', 'MICROSCOPE', 'MINE', 'MINT', 'MISS', 'MISSILE', 'MODEL', 'MOLE', 'MOON', 'MOSCOW',
  'MOUNT', 'MOUSE', 'MOUTH', 'MUG', 'NAIL', 'NEEDLE', 'NET', 'NEW YORK', 'NIGHT', 'NINJA',
  'NOTE', 'NURSE', 'NUT', 'OCTOPUS', 'OIL', 'OLIVE', 'OLYMPUS', 'OPERA', 'ORANGE', 'ORGAN',
  ...
  'SCISSORS', 'SCORPION', 'SCREEN', 'SCUBA DIVER', 'SEAL', 'SERVER', 'SHADOW', 'SHARK', 'SHIP', 'SHOE',
